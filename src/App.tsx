...
import { Terminal, User, Code, Mail, Github, Linkedin, ExternalLink, Heart, MapPin, Phone } from 'lucide-react';
...
const App: React.FC = () => {
    ...
    projects: [
      {
        ...
        description: "Full-stack web application for restaurant reservations with real-time availability",
      ...
      },
      {
        ...
        description: "Machine learning application for medical image analysis and tumor detection",
        tech: "Python, TensorFlow, OpenCV, Flask",
        features: "Image preprocessing, CNN model, web interface for predictions"
      }
    ],
    experience: [
  ...
  useEffect(() => {
    ...
    }, (lastCommand.currentCharIndex || 0) === 0 && (lastCommand.currentLineIndex || 0) > 0 ? lineDelay : typingSpeed);
    ...
    <div className="min-h-screen bg-black text-green-400 flex">
        ...
        <div className="relative">
          ...
          <div className="bg-gray-900 border-2 border-green-400/50 rounded-lg p-6 w-80 shadow-2xl animate-float">
            ...
            <div className="text-center space-y-2">
              <h2 className="text-green-400 font-bold text-xl">{portfolioData.name}</h2>
              ...
              <div className="flex justify-center space-x-4 pt-3">
                <a href={portfolioData.contact.github} className="text-green-400 hover:text-green-300 transition-colors">
                  <Github className="w-5 h-5" />
                </a>
                <a href={portfolioData.contact.linkedin} className="text-green-400 hover:text-green-300 transition-colors">
      ...
      <div className="w-1/2 flex flex-col relative z-10">
        ...
        <div className="bg-gray-900/90 border-b border-green-400/30 px-4 py-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-green-400 text-sm font-mono">jaisun@portfolio: ~</span>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col p-4">
          ...
          >
              ...
              <div key={index} className="space-y-1 mb-4">
                ...
                {getDisplayedOutput(cmd).map((line, lineIndex) => (
                  <div key={lineIndex} className="text-white pl-0">
                    {line}
                    {cmd.isTyping && lineIndex === getDisplayedOutput(cmd).length - 1 && (
            ...
            <form onSubmit={handleSubmit} className="flex items-center mt-2">
              ...
              />
              {!isProcessing && <span className="text-blue-400 animate-pulse ml-1">█</span>}
            </form>
          </div>
        </div>
      </div>
      ...
      <div className="absolute right-8 top-8 z-20">
        ...
        >
          ...
          <span className="text-green-400 font-bold text-sm">{likes.toLocaleString()}</span>
        </button>
      </div>
    </div>
  );
